...
ctx.lineWidth = 1;
ctx.rect(x=150, y=143,   width = 430,  height = 230);
ctx.stroke();
...
ctx.lineWidth = 5;
ctx.arc(x=150, y=143, radius=40, startAngle=0,  endAngle=2*Math.PI);
ctx.stroke();
...
ctx.lineWidth = 5
ctx.arc(x=350, y=210, radius=40, startAngle=0,  endAngle=2*Math.PI);
ctx.stroke()
...
ctx.strokeStyle = "red";
ctx.lineWidth = 5
ctx.arc(x=210, y=40, radius=40, startAngle=0,  endAngle=2*Math.PI);
ctx.stroke()
...
ctx.lineWidth = 5
ctx.arc(x=300, y=250, radius=40, startAngle=0,  endAngle=2*Math.PI);
ctx.stroke()
...
ctx.lineWidth = 5
ctx.arc(x=400, y=250, radius=40, startAngle=0,  endAngle=2*Math.PI);
ctx.stroke()
